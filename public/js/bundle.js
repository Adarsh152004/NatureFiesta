...
},{"axios":"../../node_modules/axios/index.js"}],"clickHack.js":[function(require,module,exports) {
"use strict";
...
function _initializePage() {
  _initializePage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var qtyInput, increaseBtn, decreaseBtn, sizeButtons, addToCartBtn;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
        ...
        case 2:
          ...
          if (addToCartBtn) {
            addToCartBtn.addEventListener('click', function () {
              ...
              var size = document.querySelector('.size-btn.active').textContent;

              // Add to cart logic
              alert("Added ".concat(quantity, " ").concat(size, " ").concat(getProductById(productId).name, " to cart!"));
...
var _default = exports.default = initializePage;
...
var _clickHack = require("./clickHack.js");
...
var logOutBtn = document.querySelector('.user-logged-in');
if (loginForm) {
...
>>>>>>> 1d60c0a6bad5737b38c4d53b8897d496d0a54510
>>>>>>> e1d0db7d595c29e92b9b20d9937fe87070d4361f
